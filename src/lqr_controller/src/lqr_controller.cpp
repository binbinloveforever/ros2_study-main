  ...
  const rclcpp::Time & time, const rclcpp::Duration & period)
{
  ...
  const float set_effort[2] = {
    static_cast<float>(std::clamp(-left_wheel_set_effort, -params_.max_effort, params_.max_effort)),
    static_cast<float>(std::clamp(-right_wheel_set_effort, -params_.max_effort, params_.max_effort))};
